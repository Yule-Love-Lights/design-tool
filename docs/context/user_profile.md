---
name: user-profile
description: Jason at Yule Love Lights — Christmas/permanent lights installer building an internal quoting tool
metadata: 
  node_type: memory
  type: user
...
Jason works at **Yule Love Lights** (yulelovelights.com, info@yulelovelights.com, 631-517-0186). Signed-in email: naldoven@yulelovelights.com. Account display name in HHC: "Naldoven Seizeme".
